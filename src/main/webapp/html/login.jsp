	...
	<div class="showcase">
		...
		<div class="navbar-top">
			<ul class="left">
				...
				<li><a href="#"><i class="bx bx-time bx-xs"></i>Mon - Sat:
						8:00 - 16:00</a></li>
		...
		<div class="login">
			<div class="header">
				...
				<p>
					If you don't have an account please clink into <span><a
						href="../html/signin.jsp"> Sign in </a></span> button
				</p>
			</div>
			<div class="login-body">
				<div class="login-patten">
					...
					<form action="login" method="post">
						<table>
							...
							<tr>
								<td class="request">Password:</td>
								<td><input class="input" type="password" name="password"
									placeholder="Enter your password" required /></td>
							</tr>
							<tr class="btn-info">
								<td></td>
								<td><input type="submit" name="login-btn" value="Log in"
									class="btn"><input type="checkbox" name="remind"
									value="Reminder" class="remind"><span>Remember</span></td>
							</tr>
						</table>
					</form>
				</div>
				<div class="login-comment">
					<h1>
						WE DELIVER POTENTIAL INVESTMENT <br> OPPORTUNITY <span>
							FOR YOU AND EVERYONE</span>
					</h1>
					<p>
						We are boutique firm designed for Individual Investment, Family
						Offer <br> and Growth Stage Company seeking for maximize
						results
					</p>
				</div>
			</div>
